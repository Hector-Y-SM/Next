//!Solo usar con las que tengan lenguaje a,b

export function analizar(texto, matriz, e1,e2,e3,e4,e5,a1,a2,a3,a4,a5) {
    let txt = texto.split('');
    ...
    while (i < texto.length) {
      ...
      const a = /a/i;
      const b = /b/i;
      if(indexCaracter == 'a' || indexCaracter == 'A' || indexCaracter == 'B' || indexCaracter == 'b'){
